package br.com.rpgruler.main.view.terms.object;
...
public class TermsParameter {
     ...
     *
     * @param objClass <code>Class(?)</code> Classe do termo
     * @param name <code>String</code> Nome do termo
     */
     ...
     *
     * @return <code>Class(?)</code> Classe do termo
     */
     ...
     *
     * @return <code>String</code> Nome do termo
     */
